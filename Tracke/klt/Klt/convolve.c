...
//////////////////////////////////////////////////////////////////////////
/// \brief  获取高斯核   
/// param[in]  sigma    sigma因子   
/// param[in]  gauss    高斯核   
/// param[in]  gaussderiv    一阶高斯核   
/// return void    
//////////////////////////////////////////////////////////////////////////
  ...
  ConvolutionKernel *gaussderiv)
{
  ...
  /* Compute kernels, and automatically determine widths */
  {
    ...
    for (i = -hw ; i <= hw ; i++)  {
      ...
      gaussderiv->data[i+hw] = -i * gauss->data[i+hw];  //一阶导数    
    }

    /* Compute widths 当前设置产生3x3尺寸核   */   
  ...
  _KLT_FloatImage imgout)
{
  ...
  for (j = 0 ; j < nrows ; j++)  
  {
    ...
    /* Zero leftmost columns 前radius列梯度图像素为0，边界 */   
    for (i = 0 ; i < radius ; i++)
      *ptrout++ = 0.0;
